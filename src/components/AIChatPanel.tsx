  ...
  return (
    <motion.div
      ...
      className={`fixed z-50 flex flex-col overflow-hidden
        ...
        ${
          isDark
            ? "bg-slate-900 sm:border sm:border-slate-700/60 sm:shadow-2xl sm:shadow-black/40"
            : "bg-white sm:border sm:border-slate-200 sm:shadow-2xl sm:shadow-slate-300/50"
        }
      `}
    >
      {/* ── Header ──────────────────────────────────── */}
      ...
      >
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button
            ...
            aria-label={
              isFeaturesCollapsed ? "Show quick actions" : "Hide quick actions"
            }
          >
            <ChevronDown
      ...
      <div
        className={`shrink-0 overflow-hidden transition-all duration-300 ${
          isFeaturesCollapsed ? "max-h-0 border-b-0" : "max-h-24 border-b"
      ...
      <style>{`
        ...
        .chat-scrollbar::-webkit-scrollbar-thumb { background: ${isDark ? "rgba(59,130,246,0.25)" : "rgba(59,130,246,0.2)"}; border-radius: 9999px; }
        .chat-scrollbar::-webkit-scrollbar-thumb:hover { background: ${isDark ? "rgba(59,130,246,0.45)" : "rgba(59,130,246,0.4)"}; }
        .chat-scrollbar { scrollbar-width: thin; scrollbar-color: ${isDark ? "rgba(59,130,246,0.25) transparent" : "rgba(59,130,246,0.2) transparent"}; }
      `}</style>
      <div
      ...
      >
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            ...
            >
              I can answer questions about Mohamed's experience, skills, and
              projects.
            </p>
            {/* Suggestion Chips */}
              ...
              {[
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-all duration-200 cursor-pointer hover:-translate-y-0.5 ${
                    isDark
                      ? "bg-slate-800/60 border-slate-700 text-slate-400 hover:text-blue-400 hover:border-blue-500/30"
          ...
          >
            ...
            <div
              className={`px-4 py-3 rounded-2xl rounded-bl-md ${
                isDark ? "bg-slate-800 border border-slate-700/50" : "bg-slate-100"
              }`}
            >
      ...
      >
        <div className="flex gap-2">
          <input
            ...
            className={`flex-1 px-4 py-2.5 text-sm rounded-xl border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 ${
              isDark
                ? "bg-slate-800 border-slate-700/60 text-white placeholder-slate-500 focus:border-blue-500/50"
